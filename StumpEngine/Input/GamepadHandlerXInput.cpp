...
struct GamepadButtonSignature
{
    ...
    stump::input_pressed_type input_type;
};
...
void stump::GamepadHandler::GamepadHandlerImpl::poll_gamepad_impl()
{
    XINPUT_STATE state{};
...
void stump::GamepadHandler::GamepadHandlerImpl::bind_gamepad_button(const SDL_GamepadButton gamepad_button, const input_pressed_type input_type, std::unique_ptr<Command>&& command)
{
...
void stump::GamepadHandler::GamepadHandlerImpl::unbind_gamepad_button(const SDL_GamepadButton gamepad_button, const input_pressed_type input_type)
{
    const uint16_t xinput_button = sdl_gamepad_to_xinput(gamepad_button);
...
void stump::GamepadHandler::bind_gamepad_button(const SDL_GamepadButton gamepad_button, const input_pressed_type input_type, std::unique_ptr<Command>&& command) const
{
    m_handler_imlp->bind_gamepad_button(gamepad_button, input_type, std::move(command));
}

void stump::GamepadHandler::unbind_gamepad_button(const SDL_GamepadButton gamepad_button, const input_pressed_type input_type) const
{
